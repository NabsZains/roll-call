    ...
    data () {
      return {
        ...
        items: [
          ...
          { icon: 'create', title: 'Edit/Verify Roll-list', role: 'admin', link: '/office/roll_list_management' },
          { icon: 'verified_user', title: 'Verify Faculty Accounts', role: 'admin', link: '/office/faculty_verification' },
